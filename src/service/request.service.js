...
class RequestService {
  ...
  updateTime(id, tipe_jam, timeData) {
    ...
    const token=JSON.parse(localStorage.getItem('user')).token
    return axios
      .post(API_URL + 'updateTime',reqData, {headers: {
        "Content-Type": "multipart/form-data",
        "token": token,
      }})
      .then(response => {
  ...
  updateTeacher(id, title) {
    ...
    const token=JSON.parse(localStorage.getItem('user')).token
    return axios
      .post(API_URL + 'updateTeacher',reqData, {headers: {
  ...
  updateStudent(id, kelas) {
    ...
    const token=JSON.parse(localStorage.getItem('user')).token
    return axios
      .post(API_URL + 'updateStudent',reqData, {headers: {
        "Content-Type": "application/json",
        "token": token,
      }})
      .then(response => {
  ...
  employeedetail(nourut, year, month) {
    ...
    const token=JSON.parse(localStorage.getItem('user')).token
    return axios
      .get(API_URL + 'employeeDetail?nourut='+nourut+"&year="+year+"&month="+month, {headers: {
        "Content-Type": "multipart/form-data",
        "token": token,
      }})
      .then(response => {
  ...
  addEmployee(username, datebirth, identifier) {
    const reqData = { username:username, datebirth:datebirth, identifier:identifier };
    const token=JSON.parse(localStorage.getItem('user')).token
    return axios
      .post(API_URL + 'addEmployee',reqData, {headers: {
        "Content-Type": "multipart/form-data",
        "token": token,
      }})
      .then(response => {
  ...
  addEmployeeCsv(file) {
    ...
    const token=JSON.parse(localStorage.getItem('user')).token
    return axios
      .post(API_URL + 'importEmployee',reqData, {headers: {
        "Content-Type": "multipart/form-data",
        "token": token,
      }})
      .then(response => {
  ...
  deleteEmployee(id) {
    ...
    const token=JSON.parse(localStorage.getItem('user')).token
    return axios
      .post(API_URL + 'deleteEmployee',reqData, {headers: {
        "Content-Type": "application/json",
        "token": token,
      }})
      .then(response => {
  ...
  updateEmployee(id, title) {
    ...
    const token=JSON.parse(localStorage.getItem('user')).token
    return axios
      .post(API_URL + 'updateEmployee',reqData, {headers: {
        "Content-Type": "application/json",
        "token": token,
      }})
      .then(response => {
  ...
  downloadEmployeeReport() {
    const token=JSON.parse(localStorage.getItem('user')).token
    return axios
      .get(API_URL + 'downloadEmployeeReport', {headers: {
        "Content-Type": "multipart/form-data",
        "token": token,
      }})
      .then(response => {
