<template>
    ...
    <vue-final-modal v-model="show" classes="modal-container" content-class="modal-content" @closed="$parent.closeModal">
      <span class="modal__title">Add Student from CSV</span>
    ...
    methods: {
      handleClick () {
        console.log(this.file)
          ...
          if(this.file!="")
      {
         RequestService.addStudentCsv(this.file[0]).then((result)=>{
          ...
          this.$swal('Add Student gagal', 'Silahkan pilih file', 'error')
      }
