    ...
    >
        ...
        <v-list density="compact" nav>
            ...
            <v-list nav>
                ...
                <v-list-item prepend-icon="mdi-account-details" title="Teacher" value="teacherAccount" @click="this.$router.push('/main/Teacher')"></v-list-item>
                <v-list-item prepend-icon="mdi-account-details" title="Student" value="studentAccount" @click="this.$router.push('/main/Student')"></v-list-item>
