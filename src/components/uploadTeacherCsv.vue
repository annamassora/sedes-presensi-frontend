<template>
    ...
    <vue-final-modal v-model="show" classes="modal-container" content-class="modal-content" @closed="$parent.closeModal">
      <span class="modal__title">Add Teacher from CSV</span>
    ...
    methods: {
      handleClick () {
        console.log(this.file)
          ...
          if(this.file!="")
      {
         RequestService.addTeacherCsv(this.file[0]).then((result)=>{
          ...
          this.$swal('Add Teacher gagal', 'Silahkan pilih file', 'error')
      }
